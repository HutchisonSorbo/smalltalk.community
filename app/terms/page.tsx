          ...
          <ScrollArea className="h-[70vh] pr-4">
            <div className="space-y-6 text-sm md:text-base leading-relaxed">
              ...
              <section>
                ...
                <p>
                  For any questions regarding these Terms, please contact us at <a href="mailto:support@smalltalk.community" className="text-primary hover:underline">support@smalltalk.community</a>.
                </p>
              </section>
            </div>
          </ScrollArea>
