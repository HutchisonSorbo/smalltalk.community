          ...
          <ScrollArea className="h-[70vh] pr-4">
            <div className="space-y-6 text-sm md:text-base leading-relaxed">
              ...
              <section>
                ...
                <p className="mt-2">
                  To exercise these rights, please contact us at <a href="mailto:privacy@smalltalk.community" className="text-primary hover:underline">privacy@smalltalk.community</a>.
                </p>
              </section>
