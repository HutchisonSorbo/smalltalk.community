...
> [!IMPORTANT]
> **Project Rule Compliance:** "All errors MUST be logged to the `audit_logs` table."
> Currently, the `audit_logs` table is not defined in the schema. Implementation of this table and the corresponding error-logging logic in the routes listed below is a **P0 priority follow-up task**.

##### Authentication Routes (`/api/auth/*`)

| Endpoint | Status | Required Audit Events | Errors to Audit | Rate Limiter | Validation |
|----------|--------|----------------------|-----------------|--------------|------------|
| `/api/auth/callback` | ✅ Instrumented | `auth_success`, `auth_failure`, `token_refresh` | ⚠️ Partially | ✅ Integrated | ✅ Supabase |
| `/api/auth/register` | ✅ Instrumented | `user_register`, `auth_failure`, `validation_error` | ❌ TODO | ✅ Integrated | ✅ Zod |
...
| Endpoint | Status | Required Audit Events | Errors to Audit | Rate Limiter | Validation |
|----------|--------|----------------------|-----------------|--------------|------------|
| `/api/admin/announcements` | ✅ Instrumented | `announcement_create`, `announcement_update`, `announcement_delete` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/admin/export` | ✅ Instrumented | `data_export`, `export_failure` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/admin/feature-flags` | ✅ Instrumented | `flag_toggle`, `flag_create`, `flag_delete` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/admin/onboarding` | ✅ Instrumented | `onboarding_config_update` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/admin/revalidate` | ✅ Instrumented | `cache_revalidate` | ⚠️ Partially | ⚠️ TODO | ✅ Integrated |
| `/api/admin/users` | ✅ Instrumented | `user_update`, `user_suspend`, `role_change` | ❌ TODO | ⚠️ TODO | ✅ Zod |
...
| Endpoint | Status | Required Audit Events | Errors to Audit | Rate Limiter | Validation |
|----------|--------|----------------------|-----------------|--------------|------------|
| `/api/user/apps` | ⚠️ Needs Work | `app_add`, `app_remove`, `app_reorder` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/user/account-type` | ⚠️ Needs Work | `account_type_change` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/user/profile` | ⚠️ Needs Work | `profile_update`, `profile_delete`, `validation_error` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/user/complete-onboarding` | ⚠️ Needs Work | `onboarding_complete` | ❌ TODO | ⚠️ TODO | ✅ Zod |
...
| Endpoint | Status | Required Audit Events | Errors to Audit | Rate Limiter | Validation |
|----------|--------|----------------------|-----------------|--------------|------------|
| `/api/onboarding/start` | ⚠️ Needs Work | `onboarding_start` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/onboarding/profile` | ⚠️ Needs Work | `profile_create`, `profile_update`, `validation_error` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/onboarding/interests` | ⚠️ Needs Work | `interests_update` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/onboarding/situation` | ⚠️ Needs Work | `situation_update` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/onboarding/intent` | ⚠️ Needs Work | `intent_update` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/onboarding/privacy` | ⚠️ Needs Work | `privacy_settings_update` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/onboarding/recommendations` | 🟡 Read-Only | — | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/onboarding/select-apps` | ⚠️ Needs Work | `apps_selected` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/onboarding/status` | 🟡 Read-Only | — | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/onboarding/complete` | ⚠️ Needs Work | `onboarding_complete` | ❌ TODO | ⚠️ TODO | ✅ Zod |
...
| Endpoint | Status | Required Audit Events | Errors to Audit | Rate Limiter | Validation |
|----------|--------|----------------------|-----------------|--------------|------------|
| `.../contact-requests` (POST) | ⚠️ Needs Work | `contact_request_create`, `rate_limit_hit` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `.../contact-requests/check` | 🟡 Read-Only | — | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `.../contact-requests/respond` | ⚠️ Needs Work | `contact_request_accept`, `contact_request_reject` | ❌ TODO | ⚠️ TODO | ✅ Zod |
...
| Endpoint | Status | Required Audit Events | Errors to Audit | Rate Limiter | Validation |
|----------|--------|----------------------|-----------------|--------------|------------|
| `.../api/reviews` (POST) | ✅ Instrumented | `review_create`, `validation_error` | ⚠️ Partially | ⚠️ TODO | ✅ Zod |
| `.../api/reviews/[target]` | 🟡 Read-Only | — | ❌ TODO | ⚠️ TODO | ✅ Zod |
...
| Endpoint | Status | Required Audit Events | Errors to Audit | Rate Limiter | Validation |
|----------|--------|----------------------|-----------------|--------------|------------|
| `/api/feedback` (POST) | ❌ Missing | `feedback_submit`, `validation_error` | ❌ TODO | ❌ TODO | ❌ TODO |

---

##### Gigs & Musicians (Local Music Network)

| Endpoint | Status | Required Audit Events | Errors to Audit | Rate Limiter | Validation |
|----------|--------|----------------------|-----------------|--------------|------------|
| `/api/gigs` (POST) | ✅ Instrumented | `gig_create`, `validation_error`, `auth_failure` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/musicians` (POST) | ✅ Instrumented | `profile_create`, `validation_error` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/musicians/[id]/contact` | ⚠️ Needs Work | `contact_request_create`, `rate_limit_hit` | ❌ TODO | ⚠️ TODO | ✅ Zod |
...
| Endpoint | Status | Required Audit Events | Errors to Audit | Rate Limiter | Validation |
|----------|--------|----------------------|-----------------|--------------|------------|
| `/api/messages` | ⚠️ Needs Work | `message_send`, `message_read`, `auth_failure` | ❌ TODO | ⚠️ TODO | ⚠️ TODO |
| `/api/notifications` | ⚠️ Needs Work | `notification_read`, `notification_mark_all_read` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/volunteer-passport/*` | ⚠️ Needs Work | `passport_update`, `application_submit`, `org_join` | ❌ TODO | ⚠️ TODO | ✅ Zod |
| `/api/reports` | ⚠️ Needs Work | `report_submit`, `report_resolve` | ❌ TODO | ⚠️ TODO | ✅ Zod |
...
|--------|---------|
| ✅ | Fully implemented |
| ⚠️ | Needs implementation / Partially covered |
| 🟡 | Read-only endpoint (low priority for write auditing) |
| ❌ | Missing and required |
| N/A | Not applicable |

> [!WARNING]
> Endpoints with **❌ TODO** in the "Errors to Audit" column are currently non-compliant with the project rule requiring all errors to be logged to the `audit_logs` table. This is a critical security and compliance gap.
