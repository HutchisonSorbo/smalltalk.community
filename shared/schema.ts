...
export const users = pgTable("users", {
  ...
  pgPolicy("users_self_read", { for: "select", to: "authenticated", using: sql`(select auth.uid()) = ${table.id}` }),
  // Users can update their own profile (if not suspended)
  pgPolicy("users_self_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.id} AND ${table.isSuspended} IS NOT TRUE`, withCheck: sql`(select auth.uid()) = ${table.id} AND ${table.isSuspended} IS NOT TRUE` }),
...
export const musicianProfiles = pgTable("musician_profiles", {
  ...
  pgPolicy("musicians_owner_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("musicians_owner_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}`, withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("musicians_owner_delete", { for: "delete", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}` }),
...
export const marketplaceListings = pgTable("marketplace_listings", {
  ...
  pgPolicy("marketplace_owner_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("marketplace_owner_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}`, withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("marketplace_owner_delete", { for: "delete", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}` }),
...
export const notifications = pgTable("notifications", {
  ...
  pgPolicy("notifications_self_read", { for: "select", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("notifications_self_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("notifications_self_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}`, withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("notifications_self_delete", { for: "delete", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}` }),
...
export const contactRequests = pgTable("contact_requests", {
  ...
  pgPolicy("contact_requests_read", { for: "select", to: "authenticated", using: sql`(select auth.uid()) = ${table.requesterId} OR (select auth.uid()) = ${table.recipientId}` }),
  pgPolicy("contact_requests_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.requesterId}` }),
  pgPolicy("contact_requests_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.recipientId} OR (select auth.uid()) = ${table.requesterId}` }),
...
export const messages = pgTable("messages", {
  ...
  pgPolicy("messages_read", { for: "select", to: "authenticated", using: sql`(select auth.uid()) = ${table.senderId} OR (select auth.uid()) = ${table.receiverId}` }),
  pgPolicy("messages_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.senderId}` }),
...
export const reviews = pgTable("reviews", {
  ...
  pgPolicy("reviews_owner_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.reviewerId}` }),
  pgPolicy("reviews_owner_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.reviewerId}`, withCheck: sql`(select auth.uid()) = ${table.reviewerId}` }),
  pgPolicy("reviews_owner_delete", { for: "delete", to: "authenticated", using: sql`(select auth.uid()) = ${table.reviewerId}` }),
...
export const bands = pgTable("bands", {
  ...
  pgPolicy("bands_owner_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("bands_owner_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}`, withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("bands_owner_delete", { for: "delete", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}` }),
...
export const bandMembers = pgTable("band_members", {
  ...
  pgPolicy("band_members_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("band_members_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}`, withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("band_members_delete", { for: "delete", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}` }),
...
export const gigs = pgTable("gigs", {
  ...
  pgPolicy("gigs_creator_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.creatorId}` }),
  pgPolicy("gigs_creator_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.creatorId}`, withCheck: sql`(select auth.uid()) = ${table.creatorId}` }),
  pgPolicy("gigs_creator_delete", { for: "delete", to: "authenticated", using: sql`(select auth.uid()) = ${table.creatorId}` }),
...
export const gigManagers = pgTable("gig_managers", {
  ...
  pgPolicy("gig_managers_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("gig_managers_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}`, withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("gig_managers_delete", { for: "delete", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}` }),
...
export const reports = pgTable("reports", {
  ...
  pgPolicy("reports_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.reporterId}` }),
...
export const classifieds = pgTable("classifieds", {
  ...
  pgPolicy("classifieds_owner_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("classifieds_owner_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}`, withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("classifieds_owner_delete", { for: "delete", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}` }),
...
export const professionalProfiles = pgTable("professional_profiles", {
  ...
  pgPolicy("pro_profiles_owner_insert", { for: "insert", to: "authenticated", withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("pro_profiles_owner_update", { for: "update", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}`, withCheck: sql`(select auth.uid()) = ${table.userId}` }),
  pgPolicy("pro_profiles_owner_delete", { for: "delete", to: "authenticated", using: sql`(select auth.uid()) = ${table.userId}` }),
