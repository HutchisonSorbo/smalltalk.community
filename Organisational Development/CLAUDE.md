...
### 7. Language & Style Standards

- **Australian English ONLY**: Use "organisation" (not organization), "centre" (not center), "programme" (not program - unless referring to computer code), "colour" (not color).
- **Punctuation**: **NO em dashes (—)**. Always use commas (,) instead.
- **Tone**: Professional, clear, and inclusive (plain English focused).
- **Reference**: Follow the design language of `smalltalk.community - Information Hub.html`.
