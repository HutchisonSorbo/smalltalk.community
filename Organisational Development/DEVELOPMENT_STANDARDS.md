...
10. [Workshop & Training Delivery](#10-workshop--training-delivery)
...
## 10. Workshop & Training Delivery

### Victorian ACFE Framework ALIGNMENT

All training/workshops must align with Adult, Community and Further Education (ACFE) Board standards in Victoria.

| Principle | Implementation |
|----------|----------------|
| **Andragogy** | Focus on self-direction, prior experience, and problem-centred learning. |
| **A-frame Structure** | Sessions must have defined Course Plans and Session Plans. |
| **Co-Design** | Participants must have genuine agency in shaping the session content. |
| **Accessibility** | All materials must meet WCAG 2.1 AA and be available in alternative formats. |

### Facilitation Standards

1. **Anti-Boring**: Use high-energy, varied delivery methods (visual, auditory, kinesthetic).
2. **Engagement**: Minimum 30% interactive participation; maximum 15 minutes of continuous talking.
3. **Safeguarding**: WWCC verified facilitators; clear boundary protocols for intergenerational sessions.
4. **Evaluation**: Mandatory pre- and post-session impact measurement using validated scales (e.g., UCLA Loneliness Scale).
