...
|-------|-------------|----------|---------------|
| **P1 - Critical** | Active breach, teen safety incident | Unauthorized access to user data, predatory behavior reported | **Immediate** |
...
1. Unauthorized access to personal information occurred
