...
function AuditLogRow({ log }: { log: AuditLogEntry }) {
    return (
        <div className="p-4 hover:bg-muted/30 transition-colors flex items-start gap-4">
            <div className={cn(
            ...
            <div className="flex-1 space-y-1">
                ...
                {log.details && (
                    <p className="text-xs text-muted-foreground bg-muted/50 p-2 rounded-md mt-2 border border-border/50 line-clamp-3">
                        {log.details}
                    </p>
                )}
            </div>
