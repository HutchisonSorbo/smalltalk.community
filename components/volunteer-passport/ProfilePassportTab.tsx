                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-start gap-3 p-4 border rounded-lg bg-gray-50 dark:bg-gray-800/50">
                            <Fingerprint className={`h-5 w-5 mt-0.5 ${identityVerified ? "text-green-600" : "text-gray-400"}`} />
                            <div>
                        ...
                        <div className="flex items-start gap-3 p-4 border rounded-lg bg-gray-50 dark:bg-gray-800/50">
                            <ShieldAlert className={`h-5 w-5 mt-0.5 ${vcssChecked ? "text-green-600" : "text-gray-400"}`} />
                            <div>
